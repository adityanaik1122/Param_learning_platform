...
export const moduleDetails: Record<number, {
  ...
  ,
  21: { learningObjectives: ['Build a complete 3D collection loop','Use Rigidbody movement and trigger pickups','Implement score plus win UI'], deepExplanation: ['Roll-a-Ball project module'], whyMatters: ['Foundational physics plus UI integration'], workflow: ['Set up player and ground','Create pickups and collection logic','Add score and win flow'], pitfalls: ['Missing trigger setup'], validation: ['Player moves','Pickups increase score','Win state shows'], exercises: ['Add timer mode'], deliverables: ['Playable Roll-a-Ball build'] },
  22: { learningObjectives: ['Create a Pong arcade game','Handle paddle input and ball bounce','Implement score and reset flow'], deepExplanation: ['Pong project module'], whyMatters: ['Core 2D collision gameplay'], workflow: ['Create paddles and ball','Add scoring','Reset rounds'], pitfalls: ['Inconsistent ball speed'], validation: ['Ball bounces and score updates'], exercises: ['Add AI paddle'], deliverables: ['Playable Pong build'] },
  23: { learningObjectives: ['Build Space Shooter with prefabs','Implement enemy waves and shooting','Manage score lives and game over'], deepExplanation: ['Space Shooter project module'], whyMatters: ['Combines spawning and combat systems'], workflow: ['Player and laser setup','Enemy and spawner setup','UI and game over'], pitfalls: ['No fire-rate control'], validation: ['Combat loop stable'], exercises: ['Add power-up'], deliverables: ['Playable Space Shooter build'] },
  24: { learningObjectives: ['Build Snake with grid movement','Implement growth and fail states','Manage restart game flow'], deepExplanation: ['Snake project module'], whyMatters: ['Deterministic step gameplay practice'], workflow: ['Head movement','Food and growth','Collision fail checks'], pitfalls: ['Reverse-direction bug'], validation: ['Growth and fail states work'], exercises: ['Speed increase by score'], deliverables: ['Playable Snake build'] },
  25: { learningObjectives: ['Build Endless Runner loop','Implement jump and obstacle spawning','Create score and retry flow'], deepExplanation: ['Endless Runner project module'], whyMatters: ['Teaches pacing and repeat challenge loops'], workflow: ['Runner input setup','Spawner setup','Game-over and restart UI'], pitfalls: ['Unstable ground detection'], validation: ['Run and retry loop works'], exercises: ['Add coins'], deliverables: ['Playable Endless Runner build'] }
};